...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('partners.edit') }}</h1>
            ...
            <form action="{{ route('admin-partners-update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_en') is-invalid @enderror" 
                               id="name_en" name="name_en" value="{{ old('name_en', $partner->name_en) }}" required>
                        @error('name_en')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                               id="name_ar" name="name_ar" dir="rtl" value="{{ old('name_ar', $partner->name_ar) }}" required>
                        @error('name_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('position_en') is-invalid @enderror" 
                               id="position_en" name="position_en" value="{{ old('position_en', $partner->position_en) }}">
                        @error('position_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('position_ar') is-invalid @enderror" 
                               id="position_ar" name="position_ar" dir="rtl" value="{{ old('position_ar', $partner->position_ar) }}">
                        @error('position_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                  id="description_en" name="description_en" rows="3">{{ old('description_en', $partner->description_en) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" name="description_ar" dir="rtl" rows="3">{{ old('description_ar', $partner->description_ar) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="twitter" class="form-label">{{ __('partners.twitter') }}</label>
                        <input type="url" class="form-control @error('twitter') is-invalid @enderror" 
                               id="twitter" name="twitter" value="{{ old('twitter', $partner->twitter) }}">
                        @error('twitter')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if($partner->image)
                            <div class="mt-2">
                                <img src="{{ asset($partner->image) }}" alt="{{ $partner->getName() }}" 
                                     class="preview-image">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control @error('order') is-invalid @enderror" 
                               id="order" name="order" min="0" value="{{ old('order', $partner->order) }}">
                        @error('order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> {{ __('partners.update') }}
                    </button>
                    <a href="{{ route('admin-partners-index') }}" class="btn btn-secondary">
                        {{ __('partners.cancel') }}
                    </a>
